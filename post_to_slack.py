...
def post_message_to_slack(share_price, changes):
    ...
    {tabulate([
        ...
        ['Last Week', share_price['week'], changes['week_change'], f"{changes['week_change_abs']}p"],
        ['Last 28 Days', share_price['month'], changes['month_change'], f"£{changes['month_change_abs']}p"],
        ['Last 6 months', share_price['half_year'], changes['half_change'], f"£{changes['half_change_abs']}p"],
